...
function problemB() {
  ...
  promisifiedReadFile('poem-one/stanza-01.txt')
    .then(stanza1 => {
      cyan('-- B. promise version (stanza one) --');
      blue(stanza1)
    })
    .catch(err => magenta(err));
  promisifiedReadFile('poem-one/stanza-02.txt')
    .then(stanza2 => {
      cyan('-- B. promise version (stanza two) --');
      blue(stanza2)
    })
    .catch(err => magenta(err));
  promisifiedReadFile('poem-one/stanza-03.txt')
    .then(stanza3 => {
      cyan('-- B. promise version (stanza three) --');
      blue(stanza3)
    })
    .catch(err => magenta(err));
}
...
function problemC() {
  ...
  //  promisifiedReadFile('poem-one/stanza-01.txt')
  //    .then(stanza => {
  //      cyan('-- C. promise version (stanza 1) --');
  //      blue(stanza);
  //    })
  //    .catch(err => magenta(err));
  promisifiedReadFile('poem-one/stanza-02.txt')
    .then(stanza => {
      cyan('-- C. promise version (stanza 2) --');
      blue(stanza);
    })
    .then(() => promisifiedReadFile('poem-one/stanza-03.txt'))
    .then(stanza => {
      cyan('-- C. promise version (stanza 3) --');
      blue(stanza);
      cyan('-- C. promise version done --');
    }).catch(err => magenta(err));
...
function problemD() {
  ...
  promisifiedReadFile('poem-one/wrong-file-name.txt')
    .then(stanza4 => {
      cyan('-- D. promise version (stanza four) --');
      blue(stanza4);
    })
    .catch(err => {
      cyan('-- D. promise version Error --');
...
function problemF() {
  ...
  promisifiedReadFile('poem-one/stanza-03.txt')
    .then(stanza => {
      cyan('-- F. promise version (stanza three) --');
      blue(stanza)
    })
    .then(() => promisifiedReadFile('poem-one/wrong-file-name.txt'))
    .then(stanza => {
      cyan('-- F. promise version (stanza four) --');
      blue(stanza);
      cyan('-- F. promise version done --');
    })
    .catch(err => {
      magenta(new Error(err));
      cyan('-- F. promise version done --');
